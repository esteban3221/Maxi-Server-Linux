                                                                                      ...
                                                                                      Gtk::Box(cobject)
{
    ...
    v_list_info_system[5] = m_builder->get_widget<Gtk::EditableLabel>("lbl_version_pos");
}
            ...
            <child>
              <object class="GtkBox">
                <child>
                  <object class="GtkLabel">
                    <property name="halign">1</property>
                    <property name="label">Version POS</property>
                  </object>
                </child>
                <child>
                  <object class="GtkEditableLabel" id="lbl_version_pos">
                    <property name="text">Type here…</property>
                    <property name="editable">false</property>
                    <property name="hexpand">true</property>
                    <property name="halign">2</property>
