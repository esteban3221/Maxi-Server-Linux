...
void Info::init_data()
{
    ...
    v_list_info_system[1]->set_text((Global::System::exec(a.c_str())).empty() ? Global::System::exec("cat /proc/device-tree/model") : Global::System::exec(a.c_str()) + " " + Global::System::exec(b.c_str()));
    ...
    v_list_info_system[5]->set_text(Maxicajero::Version::getVersion() + "+" + std::to_string(Maxicajero::Version::getBuild()));
}