...
public:
    ...
    u_int32_t m_nivel_inmo;
    u_int32_t m_ingreso;

    static Glib::RefPtr<MLevelCash> create(u_int64_t denominacion, u_int32_t cant_alm, u_int32_t cant_recy, u_int32_t nivel_inmo, u_int32_t ingreso)
    {
        return Glib::make_refptr_for_instance<MLevelCash>(new MLevelCash(denominacion, cant_alm, cant_recy, nivel_inmo, ingreso));
    }

protected:
    MLevelCash(u_int64_t denominacion, u_int32_t cant_alm, u_int32_t cant_recy, u_int32_t nivel_inmo, u_int32_t ingreso)
